...
env = environ.Env(
    ...
    RESPA_EXCHANGE_CLIENT_ID=(str, None),
    RESPA_EXCHANGE_TENANT_ID=(str, None),
)
...
RESPA_EXCHANGE_CLIENT_ID = env('RESPA_EXCHANGE_CLIENT_ID')
RESPA_EXCHANGE_TENANT_ID = env('RESPA_EXCHANGE_TENANT_ID')
